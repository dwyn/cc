...
User.find_or_create_by(email: 'admin@gmail.com') do |user|
  binding.pry
  user.display_name = 'dwieb.',
  user.admin = 'true',
  # user.email = "admin@gmail.com",
  user.encrypted_password = "$2a$11$wCPKEDRiT8YIibTfBYB.ReMjtr1FPrOzVSWFp8A0xl/hsFv0vCpA2",
  user.reset_password_token = nil, 
  user.reset_password_sent_at = nil, 
  user.remember_created_at = nil,
  user.sign_in_count = 1
  # user.current_sign_in_at: "2014-12-31 22:27:09", 
  # user.last_sign_in_at: "2014-12-31 22:27:09", 
